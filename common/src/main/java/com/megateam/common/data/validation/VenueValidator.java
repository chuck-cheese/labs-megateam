...
public class VenueValidator
{
	 ...
	 */
	public static void validateVenueCapacity(Integer capacity) throws NullValidationException, BoundValidationException
	{
		if (capacity == null) throw new NullValidationException("Venue capacity cannot be null");

		if (capacity <= 0) throw new BoundValidationException("Venue capacity should be greater than zero");
	}
